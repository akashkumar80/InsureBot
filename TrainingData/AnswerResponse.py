...
"May I know your relationship with {policy_holder_name}?": {
 ...
 "Do you handle {policy_holder_name}'s life insurance policy number {policy_number}? Are you aware of the details of this policy?": {
            "yes": [
                    "Yes",
                    "Yes, I do",
                    "Yes, I handle it",
...
" Thank you sir/maam, I will arrange your call back at the given time.": {
            "instantResponse": [
                    "Thank you.",
                    "Thanks.",
                    "Alright, thank you.",
...
"You can download the policy bond through whatsapp. Please send a message from your registered mobile number on 8806727272 and you will be able to download the policy bond.": {
            "instantResponse": [
...
"If you wish, you can pay online now. We’ll send you a link, or you can visit our website. You can use Debit card, Credit card, Net banking, PhonePe, Whatsapp or Google Pay to make the payment.": {
            "branch":  [
...
"As confirmed, you’ll pay the premium on October 5, 2024, at 10:00 AM via online transfer. Please ensure timely payment to maintain your policy benefits. We’ll call to confirm the payment status.": {
            "instantResponse": [
...
"Could you please provide the transaction id or reference id? For cheque payments, we’ll need the cheque number. I can assist with further tracking if needed.": {
            "instantResponse": [
...
"For any further assistance with your policy, feel free to call our helpline at 1800 209 7272, message us on whatsapp on 8806 727272, mail us or visit our website. Thank you for your valuable time. Have a great day ahead.": {
    "instantResponse": [],
}
}